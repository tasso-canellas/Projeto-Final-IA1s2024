...
# https://github.com/alyssaq/face_morpher/blob/dlib/facemorpher/plotter.py
...
class Plotter(object):
  ...
  def save_one(self, img, filename=None):
    mpimg.imsave(os.path.join(self.out_folder, filename), bgr2rgb(img), format='png')
    #print(os.path.join(self.out_folder,filename) + ' saved')
